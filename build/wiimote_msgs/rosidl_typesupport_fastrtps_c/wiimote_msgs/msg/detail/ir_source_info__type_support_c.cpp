  ...
  void * untyped_ros_message)
{
  ...
  _IrSourceInfo__ros_msg_type * ros_message = static_cast<_IrSourceInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
{
  return max_serialized_size_wiimote_msgs__msg__IrSourceInfo(
    full_bounded, 0);
}
