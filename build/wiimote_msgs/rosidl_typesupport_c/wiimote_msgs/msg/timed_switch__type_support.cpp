...
static const _TimedSwitch_type_support_symbol_names_t _TimedSwitch_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, wiimote_msgs, msg, TimedSwitch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, wiimote_msgs, msg, TimedSwitch)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, wiimote_msgs, msg, TimedSwitch)() {
  return &::wiimote_msgs::msg::rosidl_typesupport_c::TimedSwitch_message_type_support_handle;
}
