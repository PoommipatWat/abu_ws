...
#define NODE_MAIN_LOGGER_NAME "teleop_wiimote_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libteleop_wiimote.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<TeleopWiimote>";
