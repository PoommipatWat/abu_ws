...
#define NODE_MAIN_LOGGER_NAME "wiimote_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libwiimote_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<WiimoteNode>";
