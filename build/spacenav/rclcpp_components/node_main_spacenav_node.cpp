...
#define NODE_MAIN_LOGGER_NAME "spacenav_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libspacenav.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<spacenav::Spacenav>";
