...
struct State_
{
  ...
  using _ir_tracking_type =
    std::vector<wiimote_msgs::msg::IrSourceInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<wiimote_msgs::msg::IrSourceInfo_<ContainerAllocator>>::other>;
  ...
  Type & set__ir_tracking(
    const std::vector<wiimote_msgs::msg::IrSourceInfo_<ContainerAllocator>, typename ContainerAllocator::template rebind<wiimote_msgs::msg::IrSourceInfo_<ContainerAllocator>>::other> & _arg)
  {
